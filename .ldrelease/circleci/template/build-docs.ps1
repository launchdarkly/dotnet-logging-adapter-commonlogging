...
# See: https://github.com/launchdarkly/project-releaser/blob/main/docs/templates/dotnet-windows.md
...
if ($docsTitle -eq "") {
    write-host "LD_RELEASE_DOCS_TITLE was not set - skipping build-docs step"
    exit
}
...
# Set up paths
$projectDir = "${env:LD_RELEASE_PROJECT_DIR}"
...
copy-item "$scriptDir\docfx-base-links.yml" -destination "$tempDocsDir"
